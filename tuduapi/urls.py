...
urlpatterns = [
    ...
    path('tasks/search/', api.TaskAPISearch.as_view(),
         name='api_tasks_search'),
    ...
    path('projects/search/', api.ProjectAPISearch.as_view(),
    ...
    path('tags/search/', api.TagAPISearch.as_view(),
         name='api_tags_search'),
